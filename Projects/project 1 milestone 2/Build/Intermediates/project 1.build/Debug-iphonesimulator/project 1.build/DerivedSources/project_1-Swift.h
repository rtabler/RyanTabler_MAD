...
SWIFT_MODULE_NAMESPACE_PUSH("project_1")
@class UIWindow;
@class UIApplication;

SWIFT_CLASS("_TtC9project_111AppDelegate")
...
SWIFT_CLASS("_TtC9project_111ChapterCell")
@interface ChapterCell : UICollectionViewCell
...
SWIFT_CLASS("_TtC9project_131ChapterCollectionViewController")
@interface ChapterCollectionViewController : UICollectionViewController <UICollectionViewDelegateFlowLayout>
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC9project_18Favorite")
@interface Favorite : RealmSwiftObject
...
SWIFT_CLASS("_TtC9project_123FavoritesViewController")
...
SWIFT_CLASS("_TtC9project_16MyData")
@interface MyData : RealmSwiftObject
@property (nonatomic, strong) RLMArray<id> * _Nonnull favorites;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithRealm:(RLMRealm * _Nonnull)realm schema:(RLMObjectSchema * _Nonnull)schema OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithValue:(id _Nonnull)value schema:(RLMSchema * _Nonnull)schema OBJC_DESIGNATED_INITIALIZER;
@end
...
- (IBAction)favoriteButtonAction:(UIButton * _Nonnull)sender;
- (IBAction)shareButtonAction:(UIButton * _Nonnull)sender;
@property (nonatomic, weak) IBOutlet UITextView * _Null_unspecified bodyText;
- (void)viewDidLoad;
- (void)didReceiveMemoryWarning;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC9project_114ViewController")
